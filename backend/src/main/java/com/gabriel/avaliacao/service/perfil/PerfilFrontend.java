 ...
 */
public class PerfilFrontend extends PerfilAbstract{

    public static final List<SkillTipoEnum> SKILLS = Arrays.asList(SkillTipoEnum.HTML, SkillTipoEnum.CSS, SkillTipoEnum.JAVASCRIPT);
